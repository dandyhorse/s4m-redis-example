...
// Offtop: Мьютекс (от англ. mutual exclusion — «взаимное исключение») — это примитив синхронизации,
// который позволяет только одному потоку получить доступ к общему ресурсу в определённый момент времени
